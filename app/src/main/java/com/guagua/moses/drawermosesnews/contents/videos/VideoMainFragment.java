package com.guagua.moses.drawermosesnews.contents.videos;
...
import com.guagua.moses.drawermosesnews.utils.PagerSlidingTabStrip;
...
public class VideoMainFragment extends Fragment {
    ...
    public void initView(View v) {
        ...
        mPagerSlidingTabStrip.setDividerColor(getResources().getColor(android.R.color.darker_gray));
        mPagerSlidingTabStrip.setIndicatorColor(getResources().getColor(android.R.color.holo_red_dark));
        mPagerSlidingTabStrip.setIndicatorHeight(8);
