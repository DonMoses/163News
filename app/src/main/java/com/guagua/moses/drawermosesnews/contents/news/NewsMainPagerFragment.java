...
import com.guagua.moses.drawermosesnews.contents.EmptyFragment;
...
//        Log.e("TAG", ">>>>>onCreateView>>>>>>>>mAddedTitles>>>>>>>" + mAddedTitles);
        View mView = inflater.inflate(R.layout.fragment_news_main, container, false);
        initView(mView);
        initAddCatoBtn(mView);
        return mView;
    }
...
//            Log.e("TAG", ">>>>>mAddedTitles>>>>result>>>>>>>>>>>" + mAddedTitles);
        ...
        mViewPager.setCurrentItem(mAddedTitles.size() - 1);
    }
